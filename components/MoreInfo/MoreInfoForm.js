...
export function MoreInfoForm(props) {
  ...
  // const userName = userInput[0].userName;
  // const userEmail = userInput[0].userEmail;
  // const userPhone = userInput[0].userPhone;
  // const contactNumber = userInput[0].contactNumber;
